...
<html>
  ...
  <body style="text-align:center;">
    ...
    <br/>
    <div>
	    <a href="${pageContext.request.contextPath }/client/IndexServlet?method=getAll&pageNow=1" target="body">首页</a>
	    <a href="${pageContext.request.contextPath }/client/ListCartServlet" target="body">查看购物车</a>
	    <a href="${pageContext.request.contextPath }/client/ClientListOrderServlet" target="body">查看订单</a>
    </div>
